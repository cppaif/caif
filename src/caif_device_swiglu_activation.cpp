...
void CAIF_DeviceSwiGLUActivation<ComputeT,StorageT>::Forward(
                                          ...
                                          CAIF_DeviceTensor &output)const
{
  try
  {
    ...
    {
      THROW_CAIFE("CAIF_DeviceSwiGLUActivation: output dtype != StorageT");
    }
...
template<typename ComputeT,typename StorageT>
void CAIF_DeviceSwiGLUActivation<ComputeT,StorageT>::Backward(
                                          ...
                                          CAIF_DeviceTensor &grad_up)const
{
  try
  {
    ...
    {
      THROW_CAIFE("CAIF_DeviceSwiGLUActivation: grad_output dtype != StorageT");
    }
...
CAIF_DeviceSwiGLUActivation<ComputeT,StorageT>::Clone()const
{
  return std::make_unique<CAIF_DeviceSwiGLUActivation<ComputeT,StorageT>>();
}

template class CAIF_DeviceSwiGLUActivation<float,float>;
#ifdef USE_CAIF_CUDA
template class CAIF_DeviceSwiGLUActivation<float,__half>;
template class CAIF_DeviceSwiGLUActivation<float,__nv_bfloat16>;
template class CAIF_DeviceSwiGLUActivation<__half,float>;
template class CAIF_DeviceSwiGLUActivation<__half,__half>;
template class CAIF_DeviceSwiGLUActivation<__half,__nv_bfloat16>;
template class CAIF_DeviceSwiGLUActivation<__nv_bfloat16,float>;
template class CAIF_DeviceSwiGLUActivation<__nv_bfloat16,__half>;
template class CAIF_DeviceSwiGLUActivation<__nv_bfloat16,__nv_bfloat16>;
#endif
