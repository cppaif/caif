...
void CAIF_DeviceGELUActivation<ComputeT,StorageT>::Forward(const CAIF_DeviceTensor &input,
...
template<typename ComputeT,typename StorageT>
void CAIF_DeviceGELUActivation<ComputeT,StorageT>::Backward(const CAIF_DeviceTensor &grad_output,
...
#ifdef USE_CAIF_CUDA
template class CAIF_DeviceGELUActivation<float,__half>;
template class CAIF_DeviceGELUActivation<float,__nv_bfloat16>;
template class CAIF_DeviceGELUActivation<__half,float>;
template class CAIF_DeviceGELUActivation<__half,__half>;
template class CAIF_DeviceGELUActivation<__half,__nv_bfloat16>;
template class CAIF_DeviceGELUActivation<__nv_bfloat16,float>;
template class CAIF_DeviceGELUActivation<__nv_bfloat16,__half>;
template class CAIF_DeviceGELUActivation<__nv_bfloat16,__nv_bfloat16>;
#endif
