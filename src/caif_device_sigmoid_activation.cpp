...
void CAIF_DeviceSigmoidActivation<ComputeT,StorageT>::Forward(const CAIF_DeviceTensor &input,
...
template<typename ComputeT,typename StorageT>
void CAIF_DeviceSigmoidActivation<ComputeT,StorageT>::Backward(
...
CAIF_DeviceSigmoidActivation<ComputeT,StorageT>::Clone()const
{
  return std::make_unique<CAIF_DeviceSigmoidActivation<ComputeT,StorageT>>();
}

template class CAIF_DeviceSigmoidActivation<float,float>;
#ifdef USE_CAIF_CUDA
template class CAIF_DeviceSigmoidActivation<float,__half>;
template class CAIF_DeviceSigmoidActivation<float,__nv_bfloat16>;
template class CAIF_DeviceSigmoidActivation<__half,float>;
template class CAIF_DeviceSigmoidActivation<__half,__half>;
template class CAIF_DeviceSigmoidActivation<__half,__nv_bfloat16>;
template class CAIF_DeviceSigmoidActivation<__nv_bfloat16,float>;
template class CAIF_DeviceSigmoidActivation<__nv_bfloat16,__half>;
template class CAIF_DeviceSigmoidActivation<__nv_bfloat16,__nv_bfloat16>;
#endif
