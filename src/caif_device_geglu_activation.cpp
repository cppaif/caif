...
void CAIF_DeviceGeGLUActivation<ComputeT,StorageT>::Forward(
                                          ...
                                          CAIF_DeviceTensor &output)const
{
  try
  {
    ...
    {
      THROW_CAIFE("CAIF_DeviceGeGLUActivation: output dtype != StorageT");
    }
...
template<typename ComputeT,typename StorageT>
void CAIF_DeviceGeGLUActivation<ComputeT,StorageT>::Backward(
                                          ...
                                          CAIF_DeviceTensor &grad_up)const
{
  try
  {
    ...
    {
      THROW_CAIFE("CAIF_DeviceGeGLUActivation: grad_output dtype != StorageT");
    }
...
CAIF_DeviceGeGLUActivation<ComputeT,StorageT>::Clone()const
{
  return std::make_unique<CAIF_DeviceGeGLUActivation<ComputeT,StorageT>>();
}

template class CAIF_DeviceGeGLUActivation<float,float>;
#ifdef USE_CAIF_CUDA
template class CAIF_DeviceGeGLUActivation<float,__half>;
template class CAIF_DeviceGeGLUActivation<float,__nv_bfloat16>;
template class CAIF_DeviceGeGLUActivation<__half,float>;
template class CAIF_DeviceGeGLUActivation<__half,__half>;
template class CAIF_DeviceGeGLUActivation<__half,__nv_bfloat16>;
template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,float>;
template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,__half>;
template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,__nv_bfloat16>;
#endif
