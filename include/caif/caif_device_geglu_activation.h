...
//------------------------------------------------------------------------------
// CAIF - AI Framework
// GeGLU gated activation strategy (templated on <ComputeT, StorageT>).
// output = gelu(gate) * up
//------------------------------------------------------------------------------
#pragma once
...
#ifdef USE_CAIF_CUDA
extern template class CAIF_DeviceGeGLUActivation<float,float>;
extern template class CAIF_DeviceGeGLUActivation<float,__half>;
extern template class CAIF_DeviceGeGLUActivation<float,__nv_bfloat16>;
extern template class CAIF_DeviceGeGLUActivation<__half,float>;
extern template class CAIF_DeviceGeGLUActivation<__half,__half>;
extern template class CAIF_DeviceGeGLUActivation<__half,__nv_bfloat16>;
extern template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,float>;
extern template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,__half>;
extern template class CAIF_DeviceGeGLUActivation<__nv_bfloat16,__nv_bfloat16>;
#else
extern template class CAIF_DeviceGeGLUActivation<float,float>;
#endif
