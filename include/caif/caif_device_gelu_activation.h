...
#ifdef USE_CAIF_CUDA
extern template class CAIF_DeviceGELUActivation<float,float>;
extern template class CAIF_DeviceGELUActivation<float,__half>;
extern template class CAIF_DeviceGELUActivation<float,__nv_bfloat16>;
extern template class CAIF_DeviceGELUActivation<__half,float>;
extern template class CAIF_DeviceGELUActivation<__half,__half>;
extern template class CAIF_DeviceGELUActivation<__half,__nv_bfloat16>;
extern template class CAIF_DeviceGELUActivation<__nv_bfloat16,float>;
extern template class CAIF_DeviceGELUActivation<__nv_bfloat16,__half>;
extern template class CAIF_DeviceGELUActivation<__nv_bfloat16,__nv_bfloat16>;
#else
extern template class CAIF_DeviceGELUActivation<float,float>;
#endif
