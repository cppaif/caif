...
//------------------------------------------------------------------------------
// CAIF - AI Framework
// Factory class that turns a runtime storage_dtype into the matching
// CAIF_DeviceRMSNorm<ComputeT, StorageT> instantiation, returned as a
// dtype-erased std::unique_ptr<CAIF_DeviceLayer>.
//
// Callers that have only a runtime dtype in hand (model builders,
// loaders, etc.) call CAIF_DeviceRMSNormFactory::Create(...) instead
// of instantiating the template directly.
//------------------------------------------------------------------------------
#pragma once
...
class CAIF_DeviceRMSNormFactory
{
  public:
     ...
     * specialization for the requested dtypes. RMSNorm has no MatMul
