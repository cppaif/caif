...
{
  /**
   * @brief Max pooling 2D layer for downsampling spatial dimensions
   * 
   * This layer performs max pooling operations on 2D inputs, reducing
   * spatial dimensions by taking the maximum value in each pooling window.
   * Input format: [batch, height, width, channels]
   */
  class CAIF_MaxPooling2DLayer:public CAIF_Layer
  {
    public:
      /**
       ...
       */
      CAIF_MaxPooling2DLayer(const CAIF_MaxPooling2DLayer &other);
      
      /**
       * @brief Move constructor
       * @param other Layer to move from
       */
      CAIF_MaxPooling2DLayer(CAIF_MaxPooling2DLayer &&other)noexcept;
      
      /**
       * @brief Destructor
       */
      virtual ~CAIF_MaxPooling2DLayer()=default;
       ...
       */
      CAIF_MaxPooling2DLayer &operator=(const CAIF_MaxPooling2DLayer &other);
       ...
       * @return Reference to this layer
       */
      CAIF_MaxPooling2DLayer &operator=(CAIF_MaxPooling2DLayer &&other)noexcept;
       ...
       */
      CAIF_LayerType_e LayerType()const override{return CAIF_LayerType_e::MaxPooling2D;}
    ...
    private:
      ...
      CAIF_Tensor _max_indices; ///< Indices of max values for backward pass
      CAIF_Tensor _last_input;  ///< Cached input for backward pass

      /**
       * @brief Apply max pooling to a single channel
