...
//------------------------------------------------------------------------------
// CAIF - AI Framework
// CAIF_StorageDtype_t<__nv_bfloat16> — bf16 specialization of the
// storage-dtype trait declared in caif_storage_dtype.h. Only present
...
template<>
class CAIF_StorageDtype_t<__nv_bfloat16>
{
  public:
